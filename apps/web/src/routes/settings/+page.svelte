...
<main class="mx-auto min-h-screen max-w-3xl px-5 py-8 sm:px-8 sm:py-12">
  ...
  <div class="mt-8"><PageHeader eyebrow="System settings" title="Deployment configuration." description="Review OpenRouter, processing limits, and service health. Credentials stay server-side and are never returned." /></div>
